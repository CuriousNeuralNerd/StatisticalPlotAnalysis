...
# List of reveal related keywords
reveal_keywords = [
...
def analyze_novel(novel):
    ...
    for chapter_idx, (chapter, doc) in enumerate(zip(chapters, docs)):
        ...
        # Count character mentions for each sentence if it was more than one - to convey the character interaction
    ...
    # Compute co-occurrence with crime keywords
    ...
    # Number of interactions with antagonist and protagonist
    ...
    num_clusters = 9  # different plot events
    ...
    for analysis in analyses:
        ...
        for character in analysis['major_characters']:
            ...
            features.append([
                ...
                analysis['character_first_mention'][character]['sentence'],                         # First mention
                analysis['co_occurrence_counts'].get(tuple(sorted([protagonist, character])), 0),   # Interaction with protagonist
                analysis['char_centralities'].get(character, 0)                                     # Centrality
            ])
...
# Antagonist Model - Random Forest
...
# Crime Keyword Frequency Distribution
for analysis in analyses:
    title = analysis['title']
...
# Reveal Keyword Frequency Distribution
for analysis in analyses:
    title = analysis['title']
